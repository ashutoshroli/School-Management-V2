...
import { createAdmissionInquiry, getAdmissionInquiries, updateAdmissionInquiryStatus, getPublicBranchList, getAdmissionInquiryPdf, deleteAdmissionInquiry } from "../controllers/admission.controller";
